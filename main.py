...
if __name__ == "__main__":
    ...
    " Cross-validation for best number of epochs."
    # n_epochs = range(500,2501,500)
    # kf = K_folds(n_splits=5)
    # train_kf, train_label_kf = kf.split(train, train_labels)
    ...
    #         N_net.train(X_train, y_train, epochs=n)
    #         avg_score += N_net.test(X_test, y_test)
    ...
    # n_epochs = 500 # Congress
    # n_neurons = 20 # MONKS-1
    # n_hidden_layers = 1 # MONKS-1
    # n_epochs = 500 # MONKS-1
    # n_neurons = 24 # MONKS-2
    # n_hidden_layers = 1 # MONKS-2
    # n_epochs = 500 # MONKS-2
    # n_neurons = 40 # MONKS-3
    # n_hidden_layers = 1 # MONKS-3
    # n_epochs = 500 # MONKS-3
    ...
    # start = timer()
    # N_net.train(train, train_labels, epochs=n_epochs)
    # end = timer() - start
    # print('train time: ', end)
    # start = timer()
    # N_net.test(test[0], test_labels[0])
    # end = timer() - start
    # print('Single value pred time: ', end)
    # N_net.test(test, test_labels, muted = False)
